...
class PreviousEventFragment : Fragment(), EventView {
    ...
    inner class EventFragmentUI : AnkoComponent<PreviousEventFragment> {
        override fun createView(ui: AnkoContext<PreviousEventFragment>) = with(ui) {
            linearLayout {
                ...
                presenter.getPreviousEvents(idLeague)
